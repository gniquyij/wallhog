...
But for some reasons like DNS as mentioned in [my previous post](https://gniquyij.github.io/wcrXic/gist-github-com/gist-github-com), the distance to the server, etc., connection is always a problem. 
...
Why not trigger them at the same time? I thought. Here comes [wallhog](https://github.com/gniquyij/wallhog.git). 
